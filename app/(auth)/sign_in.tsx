      ...
      <SafeAreaView>
        <View className="flex-1 bg-gray-50 px-6 justify-center">
          ...
          <View className="items-center mb-10">
            ...
            />
            <Text className="text-3xl font-bold text-gray-800">Online Robot Cart</Text>
          ...
          <TouchableOpacity
            className={`bg-blue-600 p-4 rounded-lg items-center mb-6 flex-row justify-center ${loading ? 'opacity-80' : ''}`}
